...
namespace WebWhales\TwillSeo\Tests\Helpers;
...
class AnonymousModule
{
    ...
    {
        return new self($namePlural, $app ?: App::getInstance());
    }
    ...
    public function withModelTraits(array $traits): self
    {
        $this->modelTraits = $traits;
